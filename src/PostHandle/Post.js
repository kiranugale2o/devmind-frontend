...
<h5 className="username" >props.name</h5>
    ...
    <div onClick={()=>setComment(false)} className="text h6">Line 40:3:  The href attribute requires a valid value to be accessible. Provide a valid, navigable address as the href value. If you cannot provide a valid href, but still need the element to resemble a link, use a button and change it with appropriate styles. Learn more: https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/HEAD/docs/rules/anchor-is-valid.md  jsx-a11y/anchor-is-valid</div>
    <img onClick={()=>setComment(false)} src="lossgo192.png" class="card-img-top" style={{width:"90%",height:"300px"}} alt="..."/>
  
    </div>
    <br/>
    <div className="" style={{display:"flex"}}>
        <div className="like" onClick={()=>{if(likecol=="red"){setLike(like-1); setLikeCol("black")}else{setLike(like+1); setLikeCol("red")}}} style={{margin:"0px 14px",color:`${likecol}`}}><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-heart-fill" viewBox="0 0 16 16">
  ...
  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
        ...
        <div className="save" id="save" ><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-bookmark-fill" viewBox="0 0 16 16">
  <path d="M2 2v13.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2"/>
</svg></div>

    </div>
    {commentp?<div style={{width:"100%"}}><CommentHandle/></div>:<></>}
    <hr/>

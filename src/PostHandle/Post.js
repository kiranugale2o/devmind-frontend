...
export default function Post(){
  const[mypage,setPage]=useState(false);
    return(
        <>
...
<h5 className="username" >props.name</h5>
  ...
  <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
        ...
        <NavLink to="comment"  className="comment "  style={{margin:"0px 12px"}}><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-chat" viewBox="0 0 16 16">
